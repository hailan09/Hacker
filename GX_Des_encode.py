...
def result():
    while True:
        ...
        try:
            ...
            two_passwd = bytes(two_string + ciphertext12 + input_plaintext[-8:],
                               'utf-8')  # 特征码+第一重密文的后12位数转换为bytes类型的明文，第二重密钥由第一重后12位密文+第一重后8位密钥构成,转为bytes类型
            ...
            my_password = "G" + tow_ciphertext[-14:]
